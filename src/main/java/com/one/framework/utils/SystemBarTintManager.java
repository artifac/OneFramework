...
public class SystemBarTintManager {
   ...
   *
   * If the platform is running Jelly Bean or earlier, or translucent system UI modes have not been
   * enabled in either the theme or via window flags, then this method does nothing.
   *
   ...
   * translucent system UI modes have not been enabled in either the theme or via window flags, then
