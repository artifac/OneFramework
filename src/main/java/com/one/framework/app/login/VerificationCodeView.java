...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
  ...
  public void setEtInputType(VCInputType etInputType) {
    this.mEtInputType = etInputType;
  }
  ...
  public void setEtTextSize(float etTextSize) {
    this.mEtTextSize = etTextSize;
  }
  ...
  public void setEtTextBg(int etTextBg) {
    this.mEtTextBg = etTextBg;
  }
  ...
  public void setCursorDrawable(int cursorDrawable) {
