package com.one.framework.app.blur;
...
public class BlurLayout extends FrameLayout {
  ...
  private Bitmap blur() {
    ...
    if (mViewLocked) {
      ...
      } catch (com.one.framework.app.blur.BlurKitException e) {
        return null;
  ...
  private Bitmap getDownscaledBitmapForView(View view, Rect crop, float downscaleFactor)
      throws BlurKitException, NullPointerException {
  ...
  public void lockView() {
    ...
    if (mActivityView != null && mActivityView.get() != null) {
      ...
      try {
        setAlpha(0f);
        mLockedBitmap = getDownscaledBitmapForView(view,
            new Rect(0, 0, view.getWidth(), view.getHeight()), mDownscaleFactor);
        setAlpha(1f);
