...
//    NotifyManager.getManager(context).buildNotification("您有一条新消息", message.getTitle(), message.getContent(), new Intent());
  ...
  private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
    ...
    Logger.d(TAG, "settag result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
  }
  ...
  private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
    ...
    Logger.d(TAG, "bindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
  ...
  private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
    ...
    Logger.d(TAG, "unbindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
